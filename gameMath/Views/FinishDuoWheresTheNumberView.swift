//
//  FinishDuoWheresTheNumberView.swift
//  gameMath
//
...
struct FinishDuoWheresTheNumberView: View {
...
//                                .cornerRadius(50)
//                        }
                        NavigationLink(destination: WheresTheNumberDuoView().navigationBarBackButtonHidden(false)){
                            Text("De novo!")
